...
const Home = () => {
  return (
    <div className='md:flex relative max-h-full mb-[25rem] md:mb-5'>
            ...
            <div className='   md:max-w-[65%] bg-gradient-to-r from-clr2 to-clr3 h-[27rem] md:h-[40rem] rounded-br-[45px] md:px-[8rem] px-[2rem] md:py-[4rem] py-[2rem]'>
              ...
              <h1 className='text-black font-sans font-[600]  tracking-[px] md:tracking-[-4px] leading-none text-[40px] md:text-[64px] mb-10 text-center md:text-left'>Body Mass Index Calculator</h1>
